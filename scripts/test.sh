...
case "${1:-local}" in
  ...
  --unit)
    ...
    swift test --filter 'CometCoreTests\.(InputTests|GeometryAndStorageTests|AgentTests|SecurityTests|AgentSecurityTests|TransportSecurityTests|EDIDTests|TranscriptionTests)/' \
